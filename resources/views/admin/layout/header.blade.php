<!--start Topbar for desktop and tablet-->
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top" id="topbar_desktop">
...
<!--end Topbar for desktop and tablet-->

<!--start Topbar for Mobiles-->
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-3 static-top" id="topbar_mobile">
    <div class="toggle_button d-md-inline">
        <button id="sidebarToggle" class="" type="button">
